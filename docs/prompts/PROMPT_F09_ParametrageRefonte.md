...
**DESIGN_SYSTEM.md** (nouveau — règles de design à appliquer dès cette
construction, pas en redesign après coup) fournis en contexte.
...
Applique DESIGN_SYSTEM.md dès la construction (pas de repasse ultérieure
nécessaire) : contraste des libellés, placeholders réalistes, largeur de
champ proportionnée au contenu, regroupement en sections si plus de 6
champs, p-selectbutton pour les choix binaires courts, 4 états
(vide/chargement/erreur/succès) sur chaque écran.
