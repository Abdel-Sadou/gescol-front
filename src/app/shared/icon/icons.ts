 ...
 * Utilisés par cob-icon dans la coque (sidebar, topbar).
 */
export const ICONS: Readonly<Record<string, string>> = {
    ...
    users:   'M16 19v-1a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v1M9.5 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6M21 19v-1a4 4 0 0 0-3-3.9M16.5 4.1a3 3 0 0 1 0 5.8',
    ...
    userPlus:'M15 19v-1a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v1M8.5 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6M19 8v6M16 11h6',
