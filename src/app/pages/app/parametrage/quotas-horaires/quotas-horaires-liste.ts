        ...
        <div class="card">
            <div class="flex justify-between items-center mb-4 flex-wrap gap-3">
                <h2 class="text-xl font-semibold m-0">
                    <i class="pi pi-clock mr-2" style="color:var(--color-primary)"></i>
                    {{ t('parametrage.quotasHoraires.titre') }}
                </h2>
                @if (canWrite()) {
            ...
            <div class="flex gap-3 mb-3 flex-wrap">
                <div style="min-width:200px;flex:1">
                    <p-select
                        ...
                        [showClear]="true"
                        [placeholder]="t('parametrage.quotasHoraires.filtreClassePh')">
                    </p-select>
                </div>
                <div style="min-width:200px;flex:1">
                    <p-select
                        ...
                        optionLabel="label" optionValue="value"
                        [showClear]="true"
                        [placeholder]="t('parametrage.quotasHoraires.filtreMatierePh')">
                    </p-select>
                </div>
            </div>
...
export class QuotasHorairesListe implements OnInit {
    ...
    onLoad(event: GescolLoadEvent): void {
        ...
        this.svc.getQuotasHoraires(0, 500, event.sort).subscribe({
            next: res => {
