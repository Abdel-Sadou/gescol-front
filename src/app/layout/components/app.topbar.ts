...
@Component({
    selector: '[app-topbar]',
    standalone: true,
    imports: [RouterModule, CommonModule, FormsModule, StyleClassModule, AppBreadcrumb, InputTextModule, ButtonModule, IconFieldModule, InputIconModule, RippleModule, BadgeModule, OverlayBadgeModule, AvatarModule, LanguageSwitcher],
    template: ` <div class="layout-topbar">
        ...
        <div class="topbar-right">
            <ul class="topbar-menu">
                ...
                <li class="right-sidebar-item" style="display:flex; align-items:center;">
                    <app-language-switcher variant="app" />
                </li>
                <li class="right-sidebar-item">
